...
#商户账号表
CREATE TABLE `nuomi_bis_account`(
  `id` int(11) unsigned NOT NULL auto_increment,
...
#商户门店表
CREATE TABLE `nuomi_bis_location`(
  `id` int(11) unsigned NOT NULL auto_increment,
  `name` varchar(50) NOT NULL DEFAULT '',
